...
import animals.AbstractZooFactory;
...
public class AddAnimalDialog extends JDialog implements ItemListener, ActionListener {
    ...
    public AddAnimalDialog(ZooPanel pan, String title, String type)
    {
		...
		if (type.equals("Herbivore")) animals=herb;
		else if (type.equals("Omnivore")) animals=omn;
		else animals=carn;
    ...
    public void actionPerformed(ActionEvent e)
    {
 		if(e.getSource() == ok)
		{
 			...
 			else if (animals==herb){
 				factory = AbstractZooFactory.createAnimalFactory("Plant");
 			}
 			else return;
 			
 			animal = factory.produceAnimal(chosenAnimal);
 			animal.initInstance(sl_sz.getValue(), sl_sz.getValue(), sl_hor.getValue(), sl_ver.getValue(), c, ap);
